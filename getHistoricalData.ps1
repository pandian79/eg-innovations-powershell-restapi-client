<#
	...
	.EXAMPLE
	  .\getHistoricalData.ps1 -managerurl "https://192.168.20.30:7077" -user myuser -pwd cGFzc3dvcmQ= -timeline "1 hour" -server "Microsoft SQL:apac_database:1433" -test TCP -measure "Current connections"
#>
