<#
	...
	.SYNOPSIS
	  Deleting a Component - /api/eg/orchestration/deletecomponent
	.DESCRIPTION
	  Use this API to delete a component from the eG manager.
		Ref: https://www.eginnovations.com/documentation/Automatically-Configuring-the-Target-Environment-using-REST-API/Deleting-a-Component.htm
	...
	.EXAMPLE
	  .\deletecomponent.ps1 -manager h"https://192.168.20.30:7077" -user myuser -pwd cGFzc3dvcmQ= -componenttype "Apache Web" -componentname apachetest -port 80
#>
...
#-------------------assignments----------------------	
$api = ($managerurl+'/api/eg/orchestration/deletecomponent')
