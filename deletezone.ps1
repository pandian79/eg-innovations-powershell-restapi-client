<#
	...
	.SYNOPSIS
	  Deleting a Zone - /api/eg/orchestration/deletezone
	.DESCRIPTION
	  Use this API to delete a zone from the eG manager.
		Ref: https://www.eginnovations.com/documentation/Automatically-Configuring-the-Target-Environment-using-REST-API/Deleting-a-Zone.htm
	...
	.EXAMPLE
	  .\deletezone.ps1 -managerurl "https://192.168.20.30:7077" -user myuser -pwd cGFzc3dvcmQ= -zonename myzone
#>
...
#-------------------assignments----------------------	
$api = ($managerurl+'/api/eg/orchestration/deletezone')
