<#
	...
	.SYNOPSIS
	  Deleting an External Agent - /api/eg/orchestration/deleteexternalagent
	.DESCRIPTION
	...
	.EXAMPLE
	  .\deleteexternalagent.ps1 -manager "https://192.168.20.30:7077" -user myuser -pwd cGFzc3dvcmQ= -agentname 'pandian-VirtualBox'
#>
...
#-------------------assignments----------------------	
$api = ($managerurl+'/api/eg/orchestration/deleteexternalagent')
