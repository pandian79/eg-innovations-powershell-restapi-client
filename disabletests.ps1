<#
	...
	.SYNOPSIS
	  Disabling Tests - /api/eg/orchestration/disabletests
	.DESCRIPTION
	  Use this API to disable one/more tests of a chosen component type.
		Ref: https://www.eginnovations.com/documentation/Automatically-Configuring-the-Target-Environment-using-REST-API/Disabling-Tests.htm
	...
	.EXAMPLE
	  .\disabletests.ps1 -managerurl "https://192.168.20.30:7077" -user myuser -pwd cGFzc3dvcmQ= -componenttype "Microsoft Client Desktop" -tests "Windows Services"
#>
...
#-------------------assignments----------------------	
$api = ($managerurl+'/api/eg/orchestration/disabletests')
